package vlaship.price.controller;
...
public class RootController {
    ...
    @GetMapping("/search")
    public ModelAndView search(@RequestParam String searchTerm, @RequestParam Integer size) {
        ...
        final var products = productRepository.findByNameProduct(searchTerm, size);
